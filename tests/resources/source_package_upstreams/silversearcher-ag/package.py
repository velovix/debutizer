...
def create_source_package(env: Environment) -> SourcePackage:
    upstream = SourcePackageUpstream(
        ...
        version=Version.from_string("2.2.0+git20200805-1"),
        dsc_url="http://archive.ubuntu.com/ubuntu/pool/universe/s/silversearcher-ag/silversearcher-ag_2.2.0+git20200805-1.dsc",
    )
    ...
    source_package.changelog.add(
        ChangeBlock(
            version="2.2.0+git20200805-1myorg1",
            urgency="medium",
            changes=[
